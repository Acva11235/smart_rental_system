...
export default function FleetDashboard() {
  ...
  const averageAge = Math.round(assets.reduce((sum, asset) => sum + (2024 - asset.year_of_manufacture), 0) / assets.length);
    ...
    <div className="space-y-8 pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <KpiCard
          ...
          sub={`${uniqueManufacturers} manufacturers`}
        />
        <KpiCard
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Real-time geographic distribution of all fleet assets
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {analyticsData.contracts.completed} completed this month
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{analyticsData.billing.completed}</div>
            <p className="text-xs text-muted-foreground">
              {analyticsData.billing.pending} pending payments
            </p>
          </CardContent>
        </Card>
